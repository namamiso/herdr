...
pub(crate) use self::{
    ...
    sidebar::{
        ...
        agent_panel_current_workspace_idx, agent_panel_entries, agent_panel_header_layout,
        agent_panel_project_directory_name, agent_panel_scroll_for_target,
        agent_panel_scroll_metrics, agent_panel_scrollbar_rect, collapsed_sidebar_sections,
        ...
        workspace_parent_group_state, AgentPanelHeaderLayout, WorkspaceListEntry,
    },
};
pub(crate) use self::{
