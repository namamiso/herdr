...
pub(crate) use self::{
    ...
    sidebar::{
        agent_entry_gap, agent_panel_body_rect, agent_panel_current_workspace_idx,
        agent_panel_entries, agent_panel_header_layout, agent_panel_project_directory_name,
        ...
        AgentPanelHeaderLayout, AgentPanelRow, WorkspaceListEntry,
    },
};
pub(crate) use self::{
